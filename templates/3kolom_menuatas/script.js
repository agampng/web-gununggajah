...
jQuery(function ($) {
    ...
    $('.tbis-shapes').each(function () {
        if ($(this).siblings('.tbis-slider').length) {
            $(this).remove();
        } else {
            $(this).css('z-index', 1);
        }
    ...
    var textblockTexts = $('.tbis-textblock div[class$="-text"]');
...
var navigatorResizeHandler = (function ($) {
    ...
    return function (responsiveDesign) {
        ...
        $(".tbis-slider").each(function () {
            var slider = $(this);
            var sliderWidth = slider.width();
            var nav = slider.siblings(".tbis-slidenavigator");
...
var responsiveNavigator = (function ($) {
    ...
    return function () {
        ...
        $(".tbis-slider").each(function () {
            ...
            var sliderNavigator = currentSlider.siblings(".tbis-slidenavigator");
...
jQuery(function($) {
    "use strict";
    $('nav.tbis-nav').addClass("desktop-nav");
});
...
jQuery(function ($) {
    ...
    $('ul.tbis-hmenu>li:not(:first-child)').each(function () { $(this).prepend('<span class="tbis-hmenu-separator"> </span>'); });
});

jQuery(function ($) {
    "use strict";
    $("ul.tbis-hmenu a:not([href])").attr('href', '#').click(function (e) { e.preventDefault(); });
});
...
jQuery(function ($) {
    ...
    */
    $.each($("ul.tbis-hmenu ul"), function () {
...
jQuery(function () {
    ...
    setHMenuOpenDirection({
        container: "div.tbis-sheet",
        defaultContainer: "#tbis-main",
        menuClass: "tbis-hmenu",
        leftToRightClass: "tbis-hmenu-left-to-right",
        rightToLeftClass: "tbis-hmenu-right-to-left"
    });
});
...
var megaMenuCreate = (function ($) {
    ...
    return function () {
        ...
        var sheetWidth = sheet.width();
        sheetWidth -= (parseInt($(".tbis-hmenu").parents("nav").css("padding-left").replace("px", ""), 10) || 0) * 2;

        // reset
        $(".tbis-hmenu .tbis-hmenu-mega-menu").removeClass("tbis-hmenu-mega-menu").css("width", "").css("left", "").css("right", "")
        ...
        $(".tbis-hmenu>li>ul").each(function() {
            var ul = $(this);
            ul.addClass("tbis-hmenu-mega-menu");

            var ltr = !ul.hasClass("tbis-hmenu-right-to-left");
            var widths = [];
            ...
            if (submenusWidth > sheetWidth) {
                ...
                $(newlineLis).each(function(index, value) {
                    $("<li class=\"cleared\" style=\"padding-top:5px;float:none;\"></div>").insertAfter(value);
                });
            }
...
var menuExtendedCreate = (function ($) {
    ...
    return function () {
        ...
        var sheetWidth = sheet.width();
        // reset
        $("#tbis-menu-style").remove();

        var styleStr = "";
        $("<style id=\"tbis-menu-style\"></style>").appendTo('head');
        var style = document.styleSheets[document.styleSheets.length - 1];

        $(".tbis-hmenu>li").each(function(i, v) {
            var itm = $(this);
            ...
            if (typeof subm.attr("data-ext-l") !== "undefined" && typeof subm.attr("data-ext-r") !== "undefined") {
                ...
                var ltr = !subm.hasClass("tbis-hmenu-right-to-left");
            ...
            if (subm.length > 0) {
                ...
                if (style !== null && typeof style.insertRule !== "undefined") {
                    var cls = "tbis-hmenu-item-" + i;
                    var selector = ".desktop ul.tbis-hmenu>li." + cls + ":hover>ul:before";
                    var r = submWidth;
...
if (browser.opera) {
    jQuery(function ($) {
        $(".tbis-header a[class$='tag-icon']").css("display", "block");
    });
}
    ...
    "use strict";
     $(window).bind("resize", function () {
        ...
        if (typeof responsiveDesign !== "undefined" && responsiveDesign.isResponsive)
            return;
        var sheetLeft = $(".tbis-sheet").offset().left;
        $("header.tbis-header #tbis-flash-area").each(function () {
            var object = $(this);
...
jQuery(function ($) {
    ...
    if (browser.ie && browser.version < 8) {
        $(window).bind('resize', function() {
            var c = $('div.tbis-content');
            var s = c.parent().children('.tbis-layout-cell:not(.tbis-content)');
            var w = 0;
            c.hide();
...
jQuery(function($) {
    ...
    $('ul.tbis-vmenu li:not(:first-child),ul.tbis-vmenu li li li:first-child,ul.tbis-vmenu>li>ul').each(function () { $(this).append('<div class="tbis-vmenu-separator"> </div><div class="tbis-vmenu-separator-bg"> </div>'); });
});
jQuery(function() {
    "use strict";
    setPopupVMenuOpenDirection({container: "div.tbis-sheet", defaultContainer: "#tbis-main", vMenuClass: "tbis-vmenu", leftToRightClass: "tbis-vmenu-left-to-right", rightToLeftClass: "tbis-vmenu-right-to-left"});
    fixPopupVMenu({vMenuClass: "tbis-vmenu", vMenuLayoutCellClass: "tbis-layout-cell"});
});
...
var artButtonSetup = (function ($) {
    ...
    return (function (className) {
        $.each($("a." + className + ", button." + className + ", input." + className), function (i, val) {
            var b = $(val);
            if (!b.hasClass('tbis-button')) {
                b.addClass('tbis-button');
            }
            if (b.is('input')) {
...
jQuery(function () {
    'use strict';
    artButtonSetup("tbis-button");
});

jQuery(function($) {
    'use strict';
    $('input.tbis-search-button, form.tbis-search input[type="submit"]').attr('value', '');
});
...
jQuery(function ($) {
    "use strict";
    var rssIcons = $(".tbis-rss-tag-icon");
    if (rssIcons.length){
        fixRssIconLineHeight("tbis-rss-tag-icon");
        if (browser.ie && browser.version < 9) {
...
var ThemeLightbox = (function ($) {
    'use strict';
    return (function () {
        var images = $(".tbis-lightbox");
        var current;
        this.init = function (ctrl) {
            $(".tbis-lightbox").mouseup({ _ctrl: ctrl }, function (e) {
                if ((e.data._ctrl === true && !e.ctrlKey) || (e.which && e.which !== 1)) {
                    return;
                }

                images = $(".tbis-lightbox");

                current = images.index(this);

                var imgContainer = $('.tbis-lightbox-wrapper');
                if (imgContainer.length === 0) {
                    imgContainer = $('<div class="tbis-lightbox-wrapper">').css('line-height', $(window).height() + "px")
                    .appendTo($("body"));
        ...
        function move(index) {
            ...
            $(".tbis-lightbox-wrapper .tbis-lightbox-image:not(.active)").remove();

            var active = $(".tbis-lightbox-wrapper .active");
            var target = $('<img class="tbis-lightbox-image" alt="" src="' + getFullImgSrc($(images[current]).attr("src")) + '" />').click(function () {
            ...
            if (active.length > 0) {
                ...
                $(".tbis-lightbox-wrapper").append(target);
            }

            showArrows();
            showLoader(true);

            bindMouse($(".tbis-lightbox-wrapper").add(target));
        ...
        function showArrows() {
            if ($(".tbis-lightbox-wrapper .arrow").length === 0) {
                $(".tbis-lightbox-wrapper").append(
            ...
            if (current === 0) {
                $(".tbis-lightbox-wrapper .arrow.left").addClass("disabled");
            } else {
                $(".tbis-lightbox-wrapper .arrow.left").removeClass("disabled");
            }

            if (current === images.length - 1) {
                $(".tbis-lightbox-wrapper .arrow.right").addClass("disabled");
            } else {
                $(".tbis-lightbox-wrapper .arrow.right").removeClass("disabled");
            }
        }

        function showError(enable) {
            if (enable) {
                $(".tbis-lightbox-wrapper").append($('<div class="lightbox-error">The requested content cannot be loaded.<br/>Please try again later.</div>')
                        .css({ "top": $(window).height() / 2 - 60, "left": $(window).width() / 2 - 170 }));
            } else {
                $(".tbis-lightbox-wrapper .lightbox-error").remove();
            }
        }

        function showLoader(enable) {
            if (!enable) {
                $(".tbis-lightbox-wrapper .loading").remove();
            }
            else {
                $('<div class="loading"> </div>').css({ "top": $(window).height() / 2 - 16, "left": $(window).width() / 2 - 16 }).appendTo($(".tbis-lightbox-wrapper"));
            }
        }

        var close = function () {
            $(".tbis-lightbox-wrapper").remove();
        };
...
(function ($) {
    ...
    var ThemeSlider = function (element, settings) {
        ...
        this.move = function (direction, next) {
            ...
            if (!nextItem.length) {
                nextItem = element.find(".tbis-slide-item")[reset]();
        ...
        if (this.settings.hover) {
            ...
            element.add(this.settings.navigator)
                   .add(element.siblings(".tbis-shapes")).hover(function () {
...
resizeData['object317681815'] = {
   responsive: [
                  { left: 0.9, top: 0.1, visible: true }, 
                  { left: 0.9, top: 0.1, visible: true }, 
                  { left: 0.9, top: 0.1, visible: true }, 
                  { left: 0.9, top: 0.1, visible: true }, 
                  { left: 0.9, top: 0.1, visible: true }, 
...
function isContentSlider(object) {
    ...
    var isPageSlider = object.parents('.tbis-pageslider').length > 0;
    if (isPageSlider)
        return false;
...
var headerObjectResizer = {
    ...
    resize: (function ($) {
        ...
        return function () {
            ...
            // move html shapes
            var headerQuery = 'header.tbis-header .tbis-shapes>*, header.tbis-header .tbis-textblock, header.tbis-header>.tbis-headline, header.tbis-header>.tbis-slogan, header.tbis-header>.tbis-positioncontrol, header.tbis-header>.tbis-logo';
            var pageSliderQuery = '.tbis-pageslider .tbis-slide-item>*';
            if (headerObjectResizer.isPreview) {
                headerQuery = 'header .tbis-slider';
                pageSliderQuery = '.tbis-pageslider .tbis-slider, .tbis-pageslider .tbis-textblock';
            }
            ...
            var slides = $('.tbis-slide-item').add(header);
            if (browser.ie && browser.version <= 8) {
                slides = slides.add('.tbis-slide-item .ie8fix');
            }
            $.each(slides, function (slideIdx, slide) {
                slide = $(slide);

                if (slide.closest('.tbis-collage').length > 0 || cleanUpStyles) {
...
jQuery(function ($) {
    ...
    if (!browser.ie || browser.version > 8)
        return;
    processElementMultiplyBg(".tbis-header", {
        "bgimage": "url('images/header.jpg')",
        "bgposition": "0 0",
        "images": "url('images/object1316593646.png'), ",
        "positions": "0px 200px, "
    });
});
if (typeof window.resizeData === 'undefined') window.resizeData = {};
