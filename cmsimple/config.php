<?php
/* utf8-marker = äöüß */
$cf['security']['password']="\$P\$BNp5/N0QDKcbIVroSrurix5voDI6Bu.";
$cf['site']['title']="bukitcintawatuprahu.com ";
...
$cf['meta']['keywords']="bukitcintawatuprahu.com ";
$cf['meta']['description']="bukitcintawatuprahu.com ";
$cf['meta']['author']="";
$cf['mailform']['email']="";
...
$cf['images']['maxsize']="30000000000";
$cf['downloads']['maxsize']="30000000000";
$cf['editor']['external']="tinymce";
$cf['editor']['height']="600";
$cf['editor']['tinymce_toolbar']="narrow";
$cf['filebrowser']['external']="";
$cf['filebrowser']['extensions_downloads']="zip, txt, swf, pdf,  doc, odt, mp3, flv, JPG, JPEG, jpg, jpeg, gif, png, tif, tiff, svg, xlsx";
...
$cf['filebrowser']['extensions_userfiles']="zip, txt, swf, pdf,  doc, odt, mp3, flv, jpg, jpeg, gif, png, tif, tiff, svg, mp4, ogg, oga, ogv, webm, xlsx";
